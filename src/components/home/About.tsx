...
import { MapPin, ShieldCheck, Zap, ArrowUpRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight flex flex-wrap gap-x-3">
              ...
              <RotatingText
                words={
                  t("about.titleHighlight", { returnObjects: true }) as string[]
                }
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <Button
                size="lg"
                className="w-fit h-14 px-8 text-base shadow-[0_4px_14px_rgba(45,212,191,0.2)] hover:scale-105 transition-transform"
                onClick={() =>
                  document
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="w-fit h-14 px-8 text-base border-primary/30 hover:border-primary hover:bg-primary/5 hover:scale-105 transition-all group"
              >
                <a
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  {t("about.features.location.description")}
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                <h4 className="text-lg font-bold group-hover:text-primary transition-colors">
                  {t("about.features.approach.title")}
                </h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  {t("about.features.approach.description")}
                </p>
              </div>
            </motion.div>
          </div>
